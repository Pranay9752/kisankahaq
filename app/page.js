        ...
        <section className="py-16 bg-gray-50">
          <div className="container px-4 mx-auto">
            <div className="mb-16 text-center">
              ...
              <div className="w-24 h-1 mx-auto mb-6 bg-emerald-600"></div>
              <p className="max-w-2xl mx-auto text-gray-600">
                Hear from farmers and buyers who have transformed their
                businesses with Kisan Ka Haq.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="flex items-center mb-4 space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-emerald-600">
                      Wheat Farmer, Gujarat
                    </p>
                  </div>
                </div>
                <p className="italic text-gray-600">
                  "With Kisan Ka Haq, I'm earning 30% more than before. Direct
                  connections with buyers have transformed my farming business
                  and I'm now investing in better seeds."
                </p>
              </div>
              ...
              <div className="p-6 bg-white rounded-lg shadow-md">
                ...
                <p className="italic text-gray-600">
                  "The quality of produce I source through Kisan Ka Haq is
                  exceptional. My customers notice the difference, and I love
                  knowing I'm supporting farmers directly."
                </p>
              </div>
              ...
              <div className="p-6 bg-white rounded-lg shadow-md">
                <div className="flex items-center mb-4 space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-emerald-600">
                      Vegetable Grower, Tamil Nadu
                    </p>
                  </div>
                </div>
                <p className="italic text-gray-600">
                  "As a woman farmer, this platform has given me independence. I
                  can set my own prices and connect with buyers from all over
                  India, expanding my business horizons."
                </p>
              </div>
            </div>
          </div>
